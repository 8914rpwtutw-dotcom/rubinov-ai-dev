    ...
    for key in api_keys:
        try:
            ...
            if result.generated_images:
                ...
                # Добавляем кнопку скачивания под картинкой
                return f'''
...
async def get_chat_ui():
    ...
    <body>
            ...
            <div id="input-wrapper">
                <div id="input-container">
                    ...
                    <div class="input-row">
                        ...
                        <!-- Кнопка прикрепления файла / фото -->
                        ...
                        <!-- НОВАЯ КНОПКА: Быстрая генерация картинки -->
        ...
        <script>
            let chats = JSON.parse(localStorage.getItem('rubinov_chats_dev') || '[]');
            let currentChatId = localStorage.getItem('rubinov_active_chat_dev') || null;
            ...
            function saveState() {
                localStorage.setItem('rubinov_chats_dev', JSON.stringify(chats));
                localStorage.setItem('rubinov_active_chat_dev', currentChatId);
                renderChats();
            }
            ...
            // Функция быстрой вставки команды на генерацию картинки
            ...
            function renderMessages(messages) {
                ...
                if (messages.length === 0) {
                    ...
                    welcome.innerHTML = `
                        ...
                        <p>Интерфейс обновлен: уменьшены элементы, добавлена кнопка быстрой генерации графики.</p>
                    `;
                ...
                messages.forEach(msg => {
                    ...
                    if (msg.role === 'user') {
                        ...
                        // Если ответ содержит HTML-теги изображений, вставляем напрямую, иначе через marked
